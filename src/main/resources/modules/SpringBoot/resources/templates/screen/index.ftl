                ...
                <el-menu
                    ...
                    <el-submenu index="3">
                        ...
                        <el-menu-item-group title="Form">
                            <el-menu-item index="/elementui/radio">Radio 单选框</el-menu-item>
                            <el-menu-item index="/elementui/checkbox">Checkbox 多选框</el-menu-item>
                            <el-menu-item index="/elementui/input">Input 输入框</el-menu-item>
                            <el-menu-item index="/elementui/inputnumber">InputNumber 计数器</el-menu-item>
                            <el-menu-item index="/elementui/select">Select 选择器</el-menu-item>
                            <el-menu-item index="/elementui/cascader">Cascader 级联选择器</el-menu-item>
                            <el-menu-item index="/elementui/switch">Switch 开关</el-menu-item>
                            <el-menu-item index="/elementui/slider">Slider 滑块</el-menu-item>
                            <el-menu-item index="/elementui/timepicker">TimePicker 时间选择器</el-menu-item>
                            <el-menu-item index="/elementui/datepicker">DatePicker 日期选择器</el-menu-item>
                            <el-menu-item index="/elementui/datetimepicker">DateTimePicker 日期时间选择器</el-menu-item>
                            <el-menu-item index="/elementui/upload">Upload 上传</el-menu-item>
                            <el-menu-item index="/elementui/rate">Rate 评分</el-menu-item>
                            <el-menu-item index="/elementui/colorpicker">ColorPicker 颜色选择器</el-menu-item>
                            <el-menu-item index="/elementui/transfer">Transfer 穿梭框</el-menu-item>
                        ...
                        <el-menu-item-group title="Data">
                            ...
                            <el-menu-item index="/elementui/tag">Tag 标签</el-menu-item>
                            <el-menu-item index="/elementui/progress">Progress 进度条</el-menu-item>
                            <el-menu-item index="/elementui/tree">Tree 树形控件</el-menu-item>
                            <el-menu-item index="/elementui/pagination">Pagination 分页</el-menu-item>
                            <el-menu-item index="/elementui/badge">Badge 标记</el-menu-item>
                        </el-menu-item-group>
                        <el-menu-item-group title="Notice">
                            <el-menu-item index="/elementui/alert">Alert 警告</el-menu-item>
                            <el-menu-item index="/elementui/loading">Loading 加载</el-menu-item>
                            <el-menu-item index="/elementui/message">Message 消息提示</el-menu-item>
                            <el-menu-item index="/elementui/messagebox">MessageBox 弹框</el-menu-item>
                            <el-menu-item index="/elementui/notification">Notification 通知</el-menu-item>
                        </el-menu-item-group>
                        <el-menu-item-group title="Navigation">
                            <el-menu-item index="/elementui/navmenu">NavMenu 导航菜单</el-menu-item>
                            <el-menu-item index="/elementui/tabs">Tabs 标签页</el-menu-item>
                            <el-menu-item index="/elementui/breadcrumb">Breadcrumb 面包屑</el-menu-item>
                            <el-menu-item index="/elementui/dropdown">Dropdown 下拉菜单</el-menu-item>
                            <el-menu-item index="/elementui/steps">Steps 步骤条</el-menu-item>
                        </el-menu-item-group>
                        <el-menu-item-group title="Others">
                            <el-menu-item index="/elementui/dialog">Dialog 对话框</el-menu-item>
                            ...
                            <el-menu-item index="/elementui/card">Card 卡片</el-menu-item>
                            <el-menu-item index="/elementui/carousel">Carousel 走马灯</el-menu-item>
                            <el-menu-item index="/elementui/collapse">Collapse 折叠面板</el-menu-item>
                        </el-menu-item-group>
                    </el-submenu>
                    <el-submenu index="4">
...
<template id="elementui_checkbox">
    <div class="view">
...
<template id="elementui_input">
    <div class="view demo-input">
...
<template id="elementui_inputnumber">
    <div class="view">
...
<template id="elementui_cascader">
    <div class="view">
...
<template id="elementui_switch"></template>
<template id="elementui_slider">
    <div class="view">
        <h1>Slider 滑块</h1>
...
<template id="elementui_timepicker">
    <div class="view">
...
<template id="elementui_datepicker">
    <div class="view">
...
<template id="elementui_datetimepicker">
    <div class="view">
...
<template id="elementui_colorpicker">
    <div class="view">
...
<template id="elementui_transfer">
    <div class="view">
        <h1>Transfer 穿梭框</h1>
        ...
        <el-card shadow="hover" class="m-t-20">
            ...
            <div>
                <div class="description"><p>可以使用
                    <code>titles</code>、<code>button-texts</code>、<code>render-content</code>
                    和 <code>format</code> 属性分别对列表标题文案、按钮文案、数据项的渲染函数和列表顶部的勾选状态文案进行自定义。数据项的渲染还可以使用
...
<template id="elementui_progress">
    <div class="view">
        <h1>Progress 进度条</h1>
...
<template id="elementui_breadcrumb">
    <div class="view">
...
<template id="elementui_dropdown">
    <div class="view">
        <h1>Dropdown 下拉菜单</h1>
...
<template id="elementui_card">
    <div class="view">
        ...
        <div class="description m-t-10"><p data-v-68fac5f9="">通过<code
                data-v-68fac5f9="">shadow</code>属性设置卡片阴影出现的时机：<code
...
<template id="elementui_carousel">
    <div class="view">
        <h1>Carousel 走马灯</h1>
...
<template id="elementui_collapse">
    <div class="view">
        <h1>Collapse 折叠面板</h1>
    ...
    $(function () {
        var router = new VueRouter({
            routes: [
                ...
                {path: '/elementui/radio', meta: {index: '3-9'}, component: Vue.extend({template: '#elementui_radio'})},
                {
                    path: '/elementui/checkbox',
                    meta: {index: '3-10'},
                    component: Vue.extend({template: '#elementui_checkbox'})
                },
                {
                    path: '/elementui/input',
                    meta: {index: '3-11'},
                    component: Vue.extend({template: '#elementui_input'})
                },
                {
                    path: '/elementui/inputnumber',
                    meta: {index: '3-12'},
                    component: Vue.extend({template: '#elementui_inputnumber'})
                },
                {
                    path: '/elementui/select',
                    meta: {index: '3-13'},
                    component: Vue.extend({template: '#elementui_select'})
                },
                {
                    path: '/elementui/cascader',
                    meta: {index: '3-14'},
                    component: Vue.extend({template: '#elementui_cascader'})
                },
                {
                    path: '/elementui/switch',
                    meta: {index: '3-15'},
                    component: Vue.extend({template: '#elementui_switch'})
                },
                {
                    path: '/elementui/slider',
                    meta: {index: '3-16'},
                    component: Vue.extend({template: '#elementui_slider'})
                },
                {
                    path: '/elementui/timepicker',
                    meta: {index: '3-17'},
                    component: Vue.extend({template: '#elementui_timepicker'})
                },
                {
                    path: '/elementui/datepicker',
                    meta: {index: '3-18'},
                    component: Vue.extend({template: '#elementui_datepicker'})
                },
                {
                    path: '/elementui/datetimepicker',
                    meta: {index: '3-19'},
                    component: Vue.extend({template: '#elementui_datetimepicker'})
                },
                {
                    path: '/elementui/upload',
                    meta: {index: '3-20'},
                    component: Vue.extend({template: '#elementui_upload'})
                },
                {path: '/elementui/rate', meta: {index: '3-21'}, component: Vue.extend({template: '#elementui_rate'})},
                {
                    path: '/elementui/colorpicker',
                    meta: {index: '3-22'},
                    component: Vue.extend({template: '#elementui_colorpicker'})
                },
                {
                    path: '/elementui/transfer',
                    meta: {index: '3-23'},
                    component: Vue.extend({template: '#elementui_transfer'})
                },
                {path: '/elementui/form', meta: {index: '3-24'}, component: Vue.extend({template: '#elementui_form'})},
                {
                    path: '/elementui/table',
                    meta: {index: '3-25'},
                    component: Vue.extend({template: '#elementui_table'})
                },
                {path: '/elementui/tag', meta: {index: '3-26'}, component: Vue.extend({template: '#elementui_tag'})},
                {
                    path: '/elementui/progress',
                    meta: {index: '3-27'},
                    component: Vue.extend({template: '#elementui_progress'})
                },
                {path: '/elementui/tree', meta: {index: '3-28'}, component: Vue.extend({template: '#elementui_tree'})},
                {
                    path: '/elementui/pagination',
                    meta: {index: '3-29'},
                    component: Vue.extend({template: '#elementui_pagination'})
                },
                {
                    path: '/elementui/badge',
                    meta: {index: '3-30'},
                    component: Vue.extend({template: '#elementui_badge'})
                },
                {
                    path: '/elementui/alert',
                    meta: {index: '3-31'},
                    component: Vue.extend({template: '#elementui_alert'})
                },
                {
                    path: '/elementui/loading',
                    meta: {index: '3-32'},
                    component: Vue.extend({template: '#elementui_loading'})
                },
                {
                    path: '/elementui/message',
                    meta: {index: '3-33'},
                    component: Vue.extend({template: '#elementui_message'})
                },
                {
                    path: '/elementui/messagebox',
                    meta: {index: '3-34'},
                    component: Vue.extend({template: '#elementui_messagebox'})
                },
                {
                    path: '/elementui/notification',
                    meta: {index: '3-35'},
                    component: Vue.extend({template: '#elementui_notification'})
                },
                {
                    path: '/elementui/navmenu',
                    meta: {index: '3-36'},
                    component: Vue.extend({template: '#elementui_navmenu'})
                },
                {path: '/elementui/tabs', meta: {index: '3-37'}, component: Vue.extend({template: '#elementui_tabs'})},
                {
                    path: '/elementui/breadcrumb',
                    meta: {index: '3-38'},
                    component: Vue.extend({template: '#elementui_breadcrumb'})
                },
                {
                    path: '/elementui/dropdown',
                    meta: {index: '3-39'},
                    component: Vue.extend({template: '#elementui_dropdown'})
                },
                {
                    path: '/elementui/steps',
                    meta: {index: '3-40'},
                    component: Vue.extend({template: '#elementui_steps'})
                },
                {
                    path: '/elementui/dialog',
                    meta: {index: '3-41'},
                    component: Vue.extend({template: '#elementui_dialog'})
                },
                {
                    path: '/elementui/tooltip',
                    meta: {index: '3-42'},
                    component: Vue.extend({template: '#elementui_tooltip'})
                },
                {
                    path: '/elementui/popover',
                    meta: {index: '3-43'},
                    component: Vue.extend({template: '#elementui_popover'})
                },
                {path: '/elementui/card', meta: {index: '3-44'}, component: Vue.extend({template: '#elementui_card'})},
                {
                    path: '/elementui/carousel',
                    meta: {index: '3-45'},
                    component: Vue.extend({template: '#elementui_carousel'})
                },
                {
                    path: '/elementui/collapse',
                    meta: {index: '3-46'},
                    component: Vue.extend({template: '#elementui_collapse'})
                },
                {
                    path: '/other/ajax',
                    meta: {index: '4-1'},
                    component: Vue.extend({
                        template: '#other_ajax', data: function () {
                            return {
                                doAjax: function () {
                                    $(function () {
        ...
        var app = new Vue({
            ...
            router: router,
            data: {
                activeIndex: "/freemarker/introduce",
                transitionName: ''
            },
            methods: {
